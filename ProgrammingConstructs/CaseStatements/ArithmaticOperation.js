...
switch(true){
case (operation1<operation2 && operation1<operation3 && operation1 <operation4):
    console.log(" minimum is "+operation1);
    break
case (operation2<operation1 && operation2<operation3 && operation2 <operation4):
    console.log(" minimum is "+operation2);
    break
case (operation3<operation1 && operation3<operation2 && operation3 <operation4):
    console.log(" minimum is "+operation3);
    break
case (operation4<operation1 && operation4<operation3 && operation4 <operation3):
